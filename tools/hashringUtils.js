...
var node = function (nodeOpts) {
    ...
    if (nodeOpts.username) this.username = nodeOpts.username;
    if (nodeOpts.password) this.password = nodeOpts.password;
    if (nodeOpts.dbname) this.dbname = nodeOpts.dbname;
};
